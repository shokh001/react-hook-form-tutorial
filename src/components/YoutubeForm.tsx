...
const YoutubeForm = () => {
  ...
  renderCount++; // no render for test
        ...
        <div className="form-control">
          ...
          <input type="text" id='twitter'
            {...register('social.twitter', {
              disabled: watch('channel') === '', // disabled if entered value in channel, then not disable twitter
          ...
          <div>
            {
              fields.map((field, index) => {
                return <div className='form-control' key={field.id}>
                  <input type="number" {...register(`phNumbers.${index}` as const)} />
